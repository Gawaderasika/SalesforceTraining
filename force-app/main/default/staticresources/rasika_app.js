var rasikaApp = angular.module("rasikaApp", ["rasikaFactory","rasikaTable"]);
rasikaApp.controller("myController", ['$scope','rasikaFactory',function($scope,factory) {
    ...
    $scope.newAccount = function(){
    	$scope.IsAccVisible = true;
        $scope.IsCntVisible = false;
    }
    $scope.newContact = function(){
    	$scope.IsAccVisible = false;
        $scope.IsCntVisible = true;
    }
}]);
