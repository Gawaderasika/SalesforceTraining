...
import UNIT_TYPE_OBJECT from '@salesforce/schema/epms__Unit_Type__c';
import PROPERTY_FIELD from '@salesforce/schema/epms__Unit_Type__c.epms__Property__c';
...
import ID_FIELD from '@salesforce/schema/epms__Unit__c.Id';
        ...
        if (propertyId !== undefined) {
            getBookingGridData({
                ...
                if (result !== undefined) { 
                    ...
                    this.template.querySelector('c-grid').refreshGrid();
                }
