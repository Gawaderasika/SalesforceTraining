...
export default class DemoLookup extends LightningElement {
  ...
  // ***** clearSelectedRecord
  clearSelectedPropertyRecord(event) {
    this.isShowSearchIcon = true;
    this.isShowClearIcon = false;
  ...
  // ***** onRecordSelection
  onPropertyRecordSelection(event) {
  ...
  // ***** getInputClass
  get getDataInputClass() {
    let css = 'slds-input slds-combobox__input slds-combobox__input-value slds-combobox__input-value '
    + (this.hasRecordSelection() ? 'has-custom-border' : '');   
    return css;
  }

  // ***** getInputValue
  get getDataInputValue(){ 
    
    return this.hasRecordSelection() ? this.selectedRecordName : this.searchTerm;
  } 
  ...
  // ***** getLookupData
  get getPropertyLookupData() {
    return this.lookupData;
  }

  // ***** clearDependentChildLookups
  @api clearDependentChildDataLookups(){
    this.isShowSearchIcon = true;
    this.isShowClearIcon = false;
    this.inputReadOnly = false;
    this.selectedRecordId = '';
  ...
  @api setSelectedRecordPropertyName(result){
